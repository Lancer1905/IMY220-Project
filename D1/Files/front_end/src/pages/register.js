...
export class Register extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                <NavBar></NavBar>
                <h1 className="login-h1" onSubmit={this.handleLogin}>Register for SickBeats!: </h1>
                <form className="login-form">
                    ...
                    <div className="inline-div">
                        ...
                        <input type={this.state.showPassword ? "text" : "password"}
                            className="input-text" placeholder="Retype password here..." required minLength={8}></input>
                        <button type="button" onClick={this.showPassword} className="show-pass">
                            <img src={this.state.showPassword ? HidePass : ShowPass}></img>
                        </button>
                    </div>
                    <Link to={`/home/${username}`}><button className="submit-btn" type="submit">Register</button></Link>
                </form>
            </>
        );
    }
